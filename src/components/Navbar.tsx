    ...
    <nav className="bg-white border-b border-gray-200 py-4 px-4 md:px-6 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link 
            to="/chapter3" 
            className={`font-medium ${isActive('/chapter3') ? 'text-primary' : 'text-gray-700 hover:text-primary'}`}
          >
            Chapter 3
          </Link>
          <Link 
          ...
          <Link 
            to="/chapter5"
            className={`font-medium ${isActive('/chapter5') ? 'text-primary' : 'text-gray-700 hover:text-primary'}`}
          >
            Chapter 5
          </Link>
        ...
        <div className="md:hidden bg-white py-4 px-4 absolute left-0 right-0 shadow-lg z-50">
          <div className="flex flex-col space-y-4">
            ...
            <Link 
              to="/chapter3" 
              onClick={() => setIsMenuOpen(false)}
              className={`font-medium py-2 ${isActive('/chapter3') ? 'text-primary' : 'text-gray-700'}`}
            >
              Chapter 3
            </Link>
            <Link 
            ...
            <Link 
              to="/chapter5" 
              onClick={() => setIsMenuOpen(false)}
              className={`font-medium py-2 ${isActive('/chapter5') ? 'text-primary' : 'text-gray-700'}`}
            >
              Chapter 5
            </Link>
